          ...
          <div className="flex flex-row justify-between items-center">
            <div className="flex flex-row items-center gap-2">
                ...
                <div className="flex flex-col">
                    <p className="text-[#333333] text-[18px] font-Montserrat leading-6">
                      {info?.address.address_line_1},
                      {' ' + info?.address.address_line_2},
                      {' ' + info?.address.landmark} <br/>
                      {info?.address.city},
                      {' ' + info?.address.state} <br/>
                      {info?.address.country} - {info?.address.zip} <br/>
                    </p>
                </div>
            </div>
            {/* <div>
